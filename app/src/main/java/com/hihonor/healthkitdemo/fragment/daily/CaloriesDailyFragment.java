 ...
 * @since 2024-08-01
 */
public class CaloriesDailyFragment extends BaseFragment {
    private static final String TAG = "CaloriesDailyFragment";
    ...
    protected void initView(View view) {
        ...
        getCaloriesDailyData();
        getEveryMinuteData();
    }

    private void getCaloriesDailyData() {
        long currentTime = System.currentTimeMillis();
        long startTime = TimeUtils.getMinTimeMillis(currentTime);
        long endTime = TimeUtils.getMaxTimeMillis(currentTime);
        Observable.create(emitter -> {
            QueryRequest queryRequestStep = new QueryRequest(DataType.SAMPLE_CALORIES_STATISTIC, startTime, endTime);
            ...
            Log.i(TAG, "getCaloriesDailyData: sampleData = " + sampleData);
            setTextViewDate((SampleData) sampleData);
        }, throwable -> {
            LogUtil.i(TAG, "getCaloriesDailyData-onFail, height error=" + throwable);
        });
    }
    ...
    private void setTextViewDate(SampleData sampleData) {
        ...
        if (sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_RUN_NAME) != null) {
            mTvOneResultUnit
                .setText(sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_RUN_NAME).toString() + " 千卡");
        } else {
            mTvOneResultUnit.setText(0 + " 千卡");
        }
        if (sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_WALK_NAME) != null) {
            mTvTwoResultUnit
                .setText(sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_WALK_NAME).toString() + " 千卡");
        } else {
            mTvTwoResultUnit.setText(0 + " 千卡");
        }
        if (sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_RIDE_NAME) != null) {
            mTvThreeResultUnit
                .setText(sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_RIDE_NAME).toString() + " 千卡");
        } else {
            mTvThreeResultUnit.setText(0 + " 千卡");
        }
        if (sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_EXCISE_NAME) != null) {
            mTvFourResultUnit
                .setText(sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_EXCISE_NAME).toString() + " 千卡");
        } else {
            mTvFourResultUnit.setText(0 + " 千卡");
        }
        if (sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_OTHER_NAME) != null) {
            mTvFiveResultUnit
                .setText(sampleData.getInteger(CaloriesStatisticField.FIELD_CALORIES_OTHER_NAME).toString() + " 千卡");
        } else {
            mTvFiveResultUnit.setText(0 + " 千卡");
        }
    }
    ...
    private void getEveryMinuteData() {
        ...
        long startTime = TimeUtils.getMinTimeMillis(currentTime);
        long endTime = TimeUtils.getMaxTimeMillis(currentTime);
        QueryRequest queryRequestStep = new QueryRequest(DataType.SAMPLE_CALORIES, startTime, endTime);
    ...
    private void insertEveryMinuteData() {
        ...
        sampleData.setDataType(DataType.SAMPLE_CALORIES);
        ...
        sampleData.putInteger(CaloriesField.FIELD_CALORIES_NAME, 23);
